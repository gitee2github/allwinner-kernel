...
printk("-------on_off:%d, gpio_is_valid(data->gpio_wlan_regon):%d , get value:%d\n", on_off,  gpio_is_valid(data->gpio_wlan_regon),gpio_get_value(data->gpio_wlan_regon));
printk("data->gpio_wlan_regon:%d\n", data->gpio_wlan_regon);
